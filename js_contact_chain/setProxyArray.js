...
var aBI = config.ProxyABI
var addr = config.ProxyAddr
console.log("coinbase:")
web3.eth.getCoinbase((err, coinbase) => {console.log(coinbase)})
var abi = JSON.parse(aBI);
var contractInstant = new web3.eth.Contract(abi, addr);
var byteCode = contractInstant.methods.setContractAddr(9, "0x12E340FD23b48233fFCD263BEc9e32aD78E3E5Aa").encodeABI()
/*
var readerStream = fs.createReadStream('controllerByteCode.txt');
